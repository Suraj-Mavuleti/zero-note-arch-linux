...
This repository contains the highly optimized, native **Arch Linux** build of Zero Note. It is engineered from the ground up to utilize native Arch Linux windowing and graphics APIs for zero-latency input and maximum performance, aiming to outperform industry standards.
...
```bash
git clone https://github.com/Suraj-Mavuleti/zero-note-arch-linux.git
cd zero-note-arch-linux
makepkg -si
```
